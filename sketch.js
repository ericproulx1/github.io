...
function draw() {
  ...
  if (safeMode === false) {
    ...
    if (keyIsDown(88) || keyIsDown(120)) { //x for brake
      me.deccelerate();
      image(brake, Track.outerWidth+200, Track.outerHeight+200, 20, 20); //make brake smaller, appear depressed
    } else {
      image(brake, Track.outerWidth+200, Track.outerHeight+200, 20, 20);
    }
